...
namespace Kotak.Entities
{
    public class SearchEntity : BaseEntity
    {
        ...
        public string RetrievalAckDate { get; set; }
        ...
        public string RetrievalAckBy { get; set; }
        ...
        public string RetrievalDispatchBy { get; set; }

        public string RetrievalDispatchDate { get; set; }
        public string RetrievalBy { get; set; }
